...
package com.appdynamics.extensions.weblogic.commons;
...
public class JMXConnectionAdapter {
    ...
    public static JMXConnectionAdapter create(String serviceUrl, String username, String password) throws MalformedURLException {
            return new JMXConnectionAdapter(serviceUrl, username, password);
    }

    public JMXConnector open(Map environmentAttributes) throws IOException {
        JMXConnector jmxConnector;
        final Map<String, Object> env = new HashMap<String, Object>();
        if (!Strings.isNullOrEmpty(username)) {
            env.put(JMXConnector.CREDENTIALS, new String[]{username, password});
            env.putAll(environmentAttributes);
            jmxConnector = JMXConnectorFactory.connect(serviceUrl, env);
        } else {
            jmxConnector = JMXConnectorFactory.connect(serviceUrl, environmentAttributes);
        }
