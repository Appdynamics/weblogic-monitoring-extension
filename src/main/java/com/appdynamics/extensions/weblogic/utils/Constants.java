...
package com.appdynamics.extensions.weblogic.utils;
...
public class Constants {
    ...
    public static final String MONITORNAME = "WebLogic Monitor";
    ...
    public static final String JMX_REMOTE_PROTOCOL_PROVIDER_PACKAGE = "jmx.remote.protocol.provider.pkgs";
    public static final String JMX_REMOTE_REQUEST_WAITING_TIMEOUT = "jmx.remote.x.request.waiting.timeout";
}
